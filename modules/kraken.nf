process kraken {
    ...
    kraken2 --db /kraken2-db/minikraken2_v1_8GB/ --use-names --report ${mypath}/kraken_out/\${samplename}.report --output ${mypath}/kraken_out/\${samplename}_kraken.out ${mypath}/\${samplename}.fastq.gz
