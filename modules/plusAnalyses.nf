process plusAnalyses {
    ...
    # not fit for PacBio data
    # determine Shigella serotype ?only illumina and ONT(nanopore)
    ...
    #   singularity exec --cleanenv docker://staphb/shigatyper:2.0.1 shigatyper --SE ${mypath}/\${samplename}.fastq.gz > ${mypath}/shigella/shigella_output.txt
    #fi
    ...
    cp ${mypath}/\${samplename}.fastq.gz ${mypath}/plasmid/
    ...
    singularity exec -e -C -B ${mypath}/plasmid:/data docker://staphb/plasmidfinder:2.1.6 plasmidfinder.py -i /data/\${samplename}.fastq.gz -o /data/
    rm ${mypath}/plasmid/\${samplename}.fastq.gz
